...
def add_house_data():
    ...
    # Add properties
    properties_list = [
        (1, 4, 1, 1, "18号楼", 8, 19, "203室", 3, 2, 1, 1, 120, "张三", "", "12923423", 1, 8000, "住宅公寓", 0),
        (1, 4, 1, 2, "19号楼", 3, 19, "303室", 2, 2, 1, 1, 100, "李四", "", "12923423", 1, 5000, "商住公寓", 0),
        (1, 4, 1, 2, "12号楼", 2, 19, "103室", 1, 2, 1, 1, 111, "王五", "", "12923423", 2, 12000, "老洋房", 0),
        (1, 4, 1, 2, "13号楼", 5, 19, "203室", 4, 2, 1, 1, 130, "赵六", "", "12923423", 3 , 20000, "花园洋房", 0),
        (1, 4, 1, 1, "18号楼", 8, 19, "203室", 3, 2, 1, 1, 120, "张三", "", "12923423", 1, 8000, "住宅公寓", 1),
        (1, 4, 1, 2, "19号楼", 3, 19, "303室", 2, 2, 1, 1, 100, "李四", "", "12923423", 1, 5000, "商住公寓", 1),
        (1, 4, 1, 2, "12号楼", 2, 19, "103室", 1, 2, 1, 1, 111, "王五", "", "12923423", 2, 12000, "老洋房", 1),
        (1, 4, 1, 2, "13号楼", 5, 19, "203室", 6, 2, 1, 1, 130, "赵六", "", "12923423", 3, 20000, "花园洋房", 2)]
...
"
    for p in properties_list:
        ...
        house.room_no = p[7]
        house.status = "可租"
        house.inclusion= "物业，发票，会所，打扫，车位"
        house.count_f = p[8]
        house.count_t = p[9]
        house.count_w = p[10]
        house.count_y = p[11]
        ...
        house.source_id = p[16]
        house.rent_price = p[17]
        house.property_type = p[18]
        house.grade = p[19]
        house.description = descrip
